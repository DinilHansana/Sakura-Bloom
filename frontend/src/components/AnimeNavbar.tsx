...
const AnimeNavbar = () => {
  return (
    <nav className="bg-gradient-to-r from-blue-300 via-blue-200 to-pink-200 shadow-md p-4 flex justify-between items-center sticky top-0 z-50">
      <h1 className="text-2xl font-bold text-gray-800 dark:text-white">SakuraBloom</h1>
      <ul className="flex flex-wrap space-x-4 text-gray-800 font-semibold dark:text-white">
        <li><Link href="/">Dashboard</Link></li>
        <li><Link href="/music">Music</Link></li>
        <li><Link href="/moderation">Moderation</Link></li>
        <li><Link href="/automod">AutoMod</Link></li>
        <li><Link href="/welcome">Welcome</Link></li>
        <li><Link href="/levels">Levels</Link></li>
        <li><Link href="/custom-commands">Custom Commands</Link></li>
        <li><Link href="/logging">Logging</Link></li>
